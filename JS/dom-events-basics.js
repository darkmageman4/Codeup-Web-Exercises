...
//     document.getElementsByClassName("sus")
//     addEventListener("click", inputForm)
// }
//
// function inputForm() {
//     document.getElementById("sus-group")
...
// function getThis() {
//     let imageNode = document.createElement("img");
//     imageNode.setAttribute("src", "kodak/pizza.png");
//     imageNode.setAttribute("class", "col-12 col-sm-6 col-md-4 px-0");
//     imageNode.setAttribute("class", "col-12");
//
//     return imageNode;
...
function jungleJuice() {
    document.getElementById("bigHead")
        .addEventListener("click", blueKnuckles);
}
